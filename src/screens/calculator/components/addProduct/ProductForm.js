...
const ProductForm = ({onAddProduct, onCancel}) => {
  // State to control modal visibility (matches the parent's showAddForm state)
  const visible = true;
    ...
    if (formData.product === 'Kitchen Cabinet') {
      return (
        <>
          ...
          <View className="mb-2">
            <Text className="text-white text-sm mb-1">Item Types</Text>
          ...
          <View className="mb-2">
            <Text className="text-white text-sm mb-1">Sections</Text>
            <View className=" rounded-lg border border-white">
              <Picker
                ...
                <Picker.Item label="Double I Shape" value="Double I Shape" />
              </Picker>
            </View>
          </View>
    ...
    <Modal
      ...
      <View className="flex-1 justify-center bg-black/50 px-4">
        <KeyboardAvoidingView
          ...
          <View className="bg-calCardgray rounded-lg p-4 relative my-auto">
            {/* Close button */}
            <TouchableOpacity
            ...
            <View className="flex-row justify-between mb-2">
              <View className="w-[48%]">
                <Text className="text-white text-sm mb-1">Series</Text>
                <View className=" rounded-lg border border-white">
                  <Picker
                    style={androidPickerStyle}
              ...
              <View className="w-[48%]">
                <Text className="text-white text-sm mb-1">Rate per SqFt</Text>
                <View className="flex-row items-center ">
                  <TextInput
                    ...
                    className=" text-white p-2 rounded-lg border border-white flex-1"
